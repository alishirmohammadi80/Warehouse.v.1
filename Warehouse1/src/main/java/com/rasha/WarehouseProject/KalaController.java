 ...
 */
package com.rasha.WarehouseProject;
...
public class KalaController {
  ...
  @GetMapping("/kalas")
    public String listkala(Model model){
     model.addAttribute("kalas",kalaServise.getAllKala());
     return "kalas";
    }
    @GetMapping("/kalas/new")
